...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MathPackage.eINSTANCE)
			...
			case MathPackage.DEFINITION_REF:
	 ...
	 * <pre>
	 * Contexts:
	 *     DefinitionRef returns DefinitionRef
	 *
	 * Constraint:
	 *     reference=[External|ID]
	 * </pre>
	 */
	protected void sequence_DefinitionRef(ISerializationContext context, DefinitionRef semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.DEFINITION_REF__REFERENCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.DEFINITION_REF__REFERENCE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDefinitionRefAccess().getReferenceExternalIDTerminalRuleCall_1_0_1(), semanticObject.eGet(MathPackage.Literals.DEFINITION_REF__REFERENCE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (source=DefinitionRef (arguments+=Exp arguments+=Exp*)?)
	 * </pre>
	 */
