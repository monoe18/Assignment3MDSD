...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDefinitionRefAccess().getGroup(), "rule__DefinitionRef__Group__0");
			...
			builder.put(grammarAccess.getFunctionCallAccess().getSourceAssignment_1(), "rule__FunctionCall__SourceAssignment_1");
			...
			builder.put(grammarAccess.getDefinitionRefAccess().getReferenceAssignment_1(), "rule__DefinitionRef__ReferenceAssignment_1");
